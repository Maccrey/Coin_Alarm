...
-- 공개 테이블 정책: 코인, 가격 이력, 뉴스 테이블은 모든 사용자가 읽기 가능
...
CREATE POLICY news_coins_select ON news_coins FOR SELECT USING (true);
...
VALUES
  ('bitcoin', 'BTC', 'Bitcoin', 'https://cryptologos.cc/logos/bitcoin-btc-logo.png'),
  ('ethereum', 'ETH', 'Ethereum', 'https://cryptologos.cc/logos/ethereum-eth-logo.png'),
  ('ripple', 'XRP', 'XRP', 'https://cryptologos.cc/logos/xrp-xrp-logo.png'),
  ('solana', 'SOL', 'Solana', 'https://cryptologos.cc/logos/solana-sol-logo.png'),
  ('dogecoin', 'DOGE', 'Dogecoin', 'https://cryptologos.cc/logos/dogecoin-doge-logo.png')
...
CREATE INDEX IF NOT EXISTS news_coins_coin_id_idx ON news_coins (coin_id);
